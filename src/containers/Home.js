...
const Home = () => {
  ...
  return (
    ...
    >
      {/* Styled Navbar */}
      <Navbar expand="lg" style={{ backgroundColor: "#343a40", position: 'sticky', top: 20, zIndex: 1 }} variant="dark" className="mb-4">
        <Container>
      ...
      <div className="container text-center mb-5">
        ...
        <div style={{ position: "relative", textAlign: "left", color: "white" }}>
          ...
          {/* Overlay Layer */}
          <div className="overlay-content bg-secondary bg-opacity-50 p-4 rounded-3 w-xs-100 w-md-50 w-lg-30">
